    ...
    <div className="h-full overflow-y-auto">
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {/* Best Case */}
          <motion.div initial={{ opacity: 0, y: 4 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5, duration: 0.15 }} className={cn('rounded-2xl border p-5', isDark ? 'bg-emerald-500/[0.03] border-emerald-500/20' : 'bg-emerald-50/50 border-emerald-200')}>
          ...
          {/* Worst Case */}
          <motion.div initial={{ opacity: 0, y: 4 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.55, duration: 0.15 }} className={cn('rounded-2xl border p-5', isDark ? 'bg-red-500/[0.03] border-red-500/20' : 'bg-red-50/50 border-red-200')}>
            <div className="flex items-center gap-2 mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {forecastData.map(f => (
                  <div key={f.metric} className="flex items-center gap-2">
                    ...
                    <div className={cn('flex-1 h-1 rounded-full', isDark ? 'bg-white/[0.06]' : 'bg-black/[0.06]')}>
                      <motion.div initial={{ width: 0 }} animate={{ width: `${f.confidence}%` }} transition={{ delay: 0.7 + forecastData.indexOf(f) * 0.05, duration: 0.15 }} className={cn('h-full rounded-full', f.confidence >= 80 ? 'bg-emerald-500' : f.confidence >= 65 ? 'bg-amber-500' : 'bg-red-500')} />
                    </div>
          ...
          {/* Key Risk Indicators */}
          <motion.div initial={{ opacity: 0, y: 4 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.65, duration: 0.15 }} className={cn('rounded-2xl border p-5', isDark ? 'bg-white/[0.02] border-white/[0.06]' : 'bg-white border-black/[0.06]')}>
            <div className="flex items-center gap-2 mb-4">
