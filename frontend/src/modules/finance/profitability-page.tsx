    ...
    >
      <div className="space-y-6">
          ...
          {clientProfitability.map((client, i) => (
            ...
            >
              ...
              <div className="mt-3 w-full h-1 rounded-full" style={{ backgroundColor: CSS.hoverBg }}>
                <motion.div initial={{ width: 0 }} animate={{ width: `${Math.min(client.margin, 100)}%` }} transition={{ delay: 0.4 + i * 0.08, duration: 0.15 }} className="h-full rounded-full" style={{ backgroundColor: getMarginColor(client.margin) }} />
              </div>
            </motion.div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <motion.div initial={{ opacity: 0, y: 4 }} animate={{ opacity: 1, y: 0 }} className="rounded-2xl border p-5" style={{ backgroundColor: CSS.cardBg, border: `1px solid ${CSS.border}`, boxShadow: CSS.shadowCard }}>
              ...
              {serviceMargins.map((svc, i) => (
                <div key={svc.service}>
                  ...
                  <div className="w-full h-2 rounded-full" style={{ backgroundColor: CSS.hoverBg }}>
                    <motion.div initial={{ width: 0 }} animate={{ width: `${Math.min(svc.margin, 100)}%` }} transition={{ delay: 0.65 + i * 0.08, duration: 0.15 }} className="h-full rounded-full" style={{ backgroundColor: getMarginColor(svc.margin) }} />
                  </div>
