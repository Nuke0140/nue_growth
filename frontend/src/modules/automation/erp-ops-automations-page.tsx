      ...
      <div className="flex items-center justify-between mb-app-xl">
        ...
        <div className="flex items-center gap-4 text-[10px]">
          <span className={cn('flex items-center gap-1.5', 'text-[var(--app-text-muted)]')}>
            <span className="h-2.5 w-2.5 rounded-[var(--app-radius-sm)] bg-zinc-400/40" /> Before
          </span>
          <span className={cn('flex items-center gap-1.5', 'text-[var(--app-text-muted)]')}>
            <span className="h-2.5 w-2.5 rounded-[var(--app-radius-sm)] bg-emerald-500" /> After
          </span>
        </div>
      </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-2.5">
              <div className={cn('flex h-10  w-9 items-center justify-center rounded-[var(--app-radius-lg)]', isDark ? 'bg-blue-500/10' : 'bg-blue-500/10')}>
          ...
          <Button className={cn('shrink-0 h-10  px-4 rounded-[var(--app-radius-lg)] text-xs font-semibold', 'bg-[var(--app-card-bg)] text-[var(--app-text)] hover:bg-[var(--app-card-bg-hover)]')}>
            <Plus className="w-4 h-4 mr-1.5" /> Create Ops Automation
          </Button>
        </div>
