      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className={cn(
              ...
              <LayoutTemplate className={cn('w-5 h-5', isDark ? 'text-white/60' : 'text-black/60')} />
            </div>
            <div>
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between gap-3 flex-wrap">
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              <ArrowUpDown className={cn('w-3.5 h-3.5', isDark ? 'text-white/30' : 'text-black/30')} />
              {sortOptions.map((opt) => (
                <button
                  key={opt}
        ...
        >
          ...
          >
            <div className={cn(
              ...
              <Plus className={cn('w-6 h-6', isDark ? 'text-violet-400' : 'text-violet-500')} />
            </div>
        ...
        {filteredTemplates.length === 0 && activeCategory !== 'All' && (
          <div className={cn(
            ...
            <LayoutTemplate className={cn('w-8 h-8 mx-auto mb-3', isDark ? 'text-white/20' : 'text-black/20')} />
