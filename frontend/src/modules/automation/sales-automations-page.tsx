      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-0">
        {steps.map((step, i) => (
          <div key={step.label} className="flex items-center gap-3 sm:gap-0 flex-1">
            <div className={cn('flex-1 rounded-[var(--app-radius-lg)] border p-3 text-center min-w-0', 'bg-[var(--app-hover-bg)] border-[var(--app-border-light)]')}>
              <div className={cn('inline-flex h-8 w-8 items-center justify-center rounded-[var(--app-radius-lg)] mx-auto mb-2', step.bg)}>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-2.5">
              <div className={cn('flex h-10  w-9 items-center justify-center rounded-[var(--app-radius-lg)]', isDark ? 'bg-emerald-500/10' : 'bg-emerald-500/10')}>
          ...
          <Button className={cn('shrink-0 h-10  px-4 rounded-[var(--app-radius-lg)] text-xs font-semibold', 'bg-[var(--app-card-bg)] text-[var(--app-text)] hover:bg-[var(--app-card-bg-hover)]')}>
            <Plus className="w-4 h-4 mr-1.5" /> Create Sales Automation
          </Button>
        </div>
