    ...
    <TooltipProvider delayDuration={300}>
      <div className={cn(
        ...
        <header className={cn(
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button variant="ghost" size="icon" onClick={closeModule}
                  className={cn('shrink-0 h-8 w-8 rounded-lg', isDark ? 'hover:bg-white/[0.06] text-white/50 hover:text-white' : 'hover:bg-black/[0.06] text-black/50 hover:text-black')}
                >
          ...
          <div className="flex items-center gap-2">
            {/* Search */}
            <div className={cn('hidden md:flex items-center gap-2 px-3 py-1.5 rounded-xl border w-64 transition-colors', 'bg-[var(--app-hover-bg)] border-[var(--app-border)]')}>
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button variant="ghost" size="icon" onClick={() => navigateTo('workflow-builder')} className="hidden md:flex h-8 w-8 rounded-lg">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button variant="ghost" size="icon" onClick={() => navigateTo('ai-autonomous-workflows')} className="relative hidden md:flex h-8 w-8 rounded-lg">
