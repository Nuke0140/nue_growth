    ...
    if (this.state.hasError) {
      return (
        <div className="flex items-center justify-center h-full min-h-[400px]">
          ...
          >
            <div className="w-16 h-16 mx-auto mb-4 rounded-[var(--app-radius-xl)] bg-red-500/10 flex items-center justify-center">
            ...
            {this.state.error && (
              <p className="text-xs text-[var(--app-text-muted)] mb-app-2xl font-mono bg-[var(--app-hover-bg)] p-3 rounded-[var(--app-radius-lg)] break-all">
