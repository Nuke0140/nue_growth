  ...
  if (field.type === 'textarea') {
    return (
      <textarea
        ...
        rows={3}
        className={cn(
          'ops-input w-full rounded-xl border bg-[var(--app-hover-bg)] text-[var(--app-text)] text-[13px] placeholder:text-[var(--app-text-disabled)] resize-none transition-colors',
          error
  ...
  if (field.type === 'select') {
    return (
      <select
        ...
        onChange={(e) => onChange(e.target.value)}
        className={cn(
          'ops-input w-full rounded-xl border bg-[var(--app-hover-bg)] text-[var(--app-text)] text-[13px] transition-colors cursor-pointer',
          error
            ? 'border-red-500/50 focus:outline-none focus:border-red-500'
            : 'border-[var(--app-border-strong)] focus:outline-none focus:border-[var(--app-accent)]/50',
  ...
  if (field.type === 'number') {
    return (
      <input
        ...
        min={0}
        className={cn(
          'ops-input w-full rounded-xl border bg-[var(--app-hover-bg)] text-[var(--app-text)] text-[13px] placeholder:text-[var(--app-text-disabled)] transition-colors',
          error
            ? 'border-red-500/50 focus:outline-none focus:border-red-500'
            : 'border-[var(--app-border-strong)] focus:outline-none focus:border-[var(--app-accent)]/50'
        )}
    ...
    return (
      <div className="space-y-2">
        ...
        <input
          ...
          onChange={(e) => onChange(e.target.value)}
          className={cn(
            'ops-input w-full rounded-xl border bg-[var(--app-hover-bg)] text-[var(--app-text)] text-[13px] transition-colors',
            error
              ? 'border-red-500/50 focus:outline-none focus:border-red-500'
              : 'border-[var(--app-border-strong)] focus:outline-none focus:border-[var(--app-accent)]/50',
