...
import { mockAiInsights, mockContacts } from '@/modules/crm-sales/data/mock-data';
import AiInsightPanel from '@/modules/crm-sales/system/shared/ai-insight-panel';
import CustomerHealthScore from '@/modules/crm-sales/system/shared/customer-health-score';
