...
import type { Contact, Activity, CrmNote, AiInsight } from '../types';
...
function getActivityIcon(type: string) {
  switch (type) {
    ...
    case 'demo': return <FileCheck className="w-3.5 h-3.5" />;
    case 'proposal': return <FileText className="w-3.5 h-3.5" />;
    case 'file_share': return <Share2 className="w-3.5 h-3.5" />;
    case 'website_visit': return <Eye className="w-3.5 h-3.5" />;
    ...
    <div className="space-y-4">
      ...
      <div className="rounded-xl p-4 space-y-2" style={{ backgroundColor: CSS.cardBg, border: `1px solid ${CSS.border}` }}>
        ...
        <div className="h-2 rounded-full overflow-hidden" style={{ backgroundColor: CSS.hoverBg }}>
          <div className="h-full rounded-full transition-all" style={{ width: `${contact.healthScore}%`, backgroundColor: healthColor }} />
        </div>
      </div>
      ...
      <div className="rounded-xl p-4 space-y-3" style={{ backgroundColor: CSS.cardBg, border: `1px solid ${CSS.border}` }}>
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-xs font-medium" style={{ color: intentColor.color, backgroundColor: intentColor.bg }}>
            {contact.aiIntent === 'high' ? <Zap className="w-3 h-3" /> : contact.aiIntent === 'medium' ? <TrendingUp className="w-3 h-3" /> : <TrendingDown className="w-3 h-3" />}
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="inline-flex items-center px-2 py-0.5 rounded-md text-xs font-medium" style={{ color: lifecycleColor.color, backgroundColor: lifecycleColor.bg }}>
