        ...
        <div className={cn(
          ...
          <header className={cn(
            ...
            <div className="flex items-center gap-2">
              <Button variant="ghost" size="icon" onClick={() => setPresentationMode(false)} className="h-8 w-8 rounded-[var(--app-radius-lg)]">
      ...
      <div className={cn(
        ...
        <header className={cn(
          ...
          <div className="flex items-center gap-2">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button variant="ghost" size="icon" onClick={() => setPresentationMode(true)} className="hidden md:flex h-8 w-8 rounded-[var(--app-radius-lg)]">
                  <Maximize2 className="w-4 h-4" />
                </Button>
              </TooltipTrigger>
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button variant="ghost" size="icon" onClick={() => navigateTo('ai-bi-assistant')} className="relative hidden md:flex h-8 w-8 rounded-[var(--app-radius-lg)]">
