...
export default function TeamInvitePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50/50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-app-3xl py-app-3xl sm:py-app-4xl">
        {/* Page Header */}
        <motion.div
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <Badge
              variant="secondary"
              className="bg-gray-100 text-gray-700 border-gray-200 text-sm font-medium rounded-[var(--app-radius-lg)] px-3 py-1 self-start sm:self-auto w-fit"
            >
