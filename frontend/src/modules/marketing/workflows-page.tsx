              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between mb-1">
                    <p className={cn('text-sm font-medium truncate pr-2', isSelected ? '' : ('text-[var(--app-text)]'))}>
                      {wf.name}
                    </p>
                    <Badge variant="secondary" className={cn(
                      'text-[9px] px-1.5 py-0 shrink-0',
                      wf.status === 'active' ? ('bg-[var(--app-success-bg)] text-[var(--app-success)]') :
                      wf.status === 'paused' ? ('bg-[var(--app-warning-bg)] text-[var(--app-warning)]') :
                      ('bg-[var(--app-hover-bg)] text-[var(--app-text-muted)]')
                    )}>
                      {wf.status}
                    </Badge>
                  </div>
                  <p className={cn('text-[10px] truncate mb-1.5', 'text-[var(--app-text-muted)]')}>
                    {wf.description}
                  </p>
                  <div className="flex items-center gap-3">
              ...
              <div className={cn(
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Badge variant="secondary" className={cn(
                    ...
                    selectedWorkflow.status === 'active' ? ('bg-[var(--app-success-bg)] text-[var(--app-success)]') :
                  ...
                  {selectedWorkflow.nodes.map((node, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <p className={cn('text-[11px] font-medium mb-0.5 truncate', 'text-[var(--app-text)]')}>
                          {node.title}
                        </p>
                        <p className={cn('text-[9px] line-clamp-2 leading-relaxed', 'text-[var(--app-text-muted)]')}>
                          {node.description}
                        </p>
                      </motion.div>
                    );
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className={cn('text-[10px] uppercase tracking-wider font-medium', 'text-[var(--app-text-muted)]')}>Total Triggers</span>
                </div>
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className={cn('text-[10px] uppercase tracking-wider font-medium', 'text-[var(--app-text-muted)]')}>Conversions</span>
                </div>
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className={cn('text-[10px] uppercase tracking-wider font-medium', 'text-[var(--app-text-muted)]')}>Conversion Rate</span>
                </div>
