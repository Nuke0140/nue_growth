                  ...
                  <div className="flex-1">
                    <div className={cn('h-10 rounded-xl overflow-hidden relative', isDark ? 'bg-white/[0.03]' : 'bg-black/[0.03]')}>
                      <motion.div
                        ...
                        transition={{ delay: i * 0.1 + 0.2, duration: 0.15, ease: [0.22, 1, 0.36, 1] }}
                    ...
                    >
                      ...
                      <div className={cn('h-2 rounded-full overflow-hidden', isDark ? 'bg-white/[0.06]' : 'bg-black/[0.06]')}>
                        <motion.div
                          initial={{ width: 0 }}
                          animate={{ width: `${width}%` }}
                          transition={{ delay: i * 0.08 + 0.3, duration: 0.15, ease: [0.22, 1, 0.36, 1] }}
                    ...
                    >
                      ...
                      <div className={cn('h-2 rounded-full overflow-hidden', isDark ? 'bg-white/[0.06]' : 'bg-black/[0.06]')}>
                        <motion.div
                          initial={{ width: 0 }}
                          animate={{ width: `${width}%` }}
                          transition={{ delay: i * 0.08 + 0.35, duration: 0.15, ease: [0.22, 1, 0.36, 1] }}
                          className={cn('h-full rounded-full transition-opacity', isSelected ? 'opacity-100' : 'opacity-50')}
                          style={{
